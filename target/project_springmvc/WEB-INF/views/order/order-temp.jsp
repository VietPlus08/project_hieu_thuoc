...
<div class="content content-flex">
  ...
  <div class="column2">
    ...
    <div class="sub-main">
      <div>
        <span>Từ ngày</span>
        <form:input type="date" path="startDate" disabled="true"/>
      </div>
      <div>
        <span>Đến ngày</span>
        <form:input type="date" path="endDate" disabled="true"/>
      </div>
      <div>
        <span>Hiển thị</span>
        <form:input type="text" path="orderType" disabled="true"/>
      </div>
      <div>
        ...
        <table class="table table-striped table-bordered">
          ...
          <c:forEach var="orderList" items="${orderLists}">
            <tr>
              ...
              <td></td>
              <td>
                <a href="${pageContext.request.contextPath}/order/edit/${orderList.id}">Edit</a>
                &nbsp;|&nbsp;
                <a href="${pageContext.request.contextPath}/order/delete/${orderList.id}">Delete</a>
              </td>
            </tr>
          </c:forEach>
        </table>
